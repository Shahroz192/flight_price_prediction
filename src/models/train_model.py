...
def train_and_tune(X: pd.DataFrame, y: pd.Series, params_space: Dict[str, Any]) -> xgb.XGBRegressor:
    """
...
def main() -> None:
    ...
    try:
        ...
        logger.error(f"Error: Data file not found at {data_path}. Please check the path.")
        return
    except Exception as e:
